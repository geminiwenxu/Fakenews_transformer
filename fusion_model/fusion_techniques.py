...
class FinalNet(nn.Module):
    ...
    def forward(self, att_layer, query):
        ...
        max_layer, inx = torch.max(torch.stack((output_layer1, output_layer2, output_layer3, output_layer4), dim=0), dim=0)
...
def get_final_output(input_att, query):
    ...
    :return:final vector
    """
    layer1 = nn.Linear(32, 32)
    layer2 = nn.Linear(32, 32)
    layer3 = nn.Linear(32, 32)
    layer4 = nn.Linear(32, 32)
    final_layer = nn.Linear(32, 32)
    norm1 = torch.nn.LayerNorm(32)
