...
#tokenizer = AutoTokenizer.from_pretrained('distilbert-base-german-cased', do_lower_case=False)
...
dev_data_loader = create_data_loader(df_dev, MAX_LEN, BATCH_SIZE)
test_data_loader = create_data_loader(df_test, MAX_LEN, BATCH_SIZE)
